...
pub fn initialize_console_commands() {
    MAP.with(|h| {
        h.borrow_mut().insert("vpoffset", ("Set viewport origin", callback(|v, i, s| {
        ...
        h.borrow_mut().insert("vpfactor", ("Set viewport zoom factor", callback(|v, i, s| {
        ...
        h.borrow_mut().insert("q", ("Quit", callback(|v, i, _s| {
